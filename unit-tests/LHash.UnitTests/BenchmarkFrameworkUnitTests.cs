...
public sealed class BenchmarkFrameworkUnitTests
{
    ...
    public void NativeBenchmarkWorkflow_ComparesCurrentAgainstPortableBLAKE3ProfilesAcrossDesktopPlatforms()
    {
        ...
        string benchmarkProject = RepositoryTestContext.ReadUtf8File(@"native-benchmarks\LHash.NativeBenchmarks\LHash.NativeBenchmarks.vcxproj");
        string benchmarkSource = RepositoryTestContext.ReadUtf8File(@"native-benchmarks\LHash.NativeBenchmarks\HashEngineBenchmarks.cpp");
        string benchmarkMain = RepositoryTestContext.ReadUtf8File(@"native-benchmarks\LHash.NativeBenchmarks\NativeBenchmarkMain.cpp");
        ...
        Assert.Contains("<ProjectName>LHash.NativeBenchmarks</ProjectName>", benchmarkProject, StringComparison.Ordinal);
        Assert.Contains(@"..\..\sub-proj\LHashNativeCore\LHashNativeCore.vcxproj", benchmarkProject, StringComparison.Ordinal);
