...
public sealed class HashContractUnitTests
{
    ...
    public void HashEngine_StartsFromHashRequest_AndEmitsProgressEvents()
    {
        ...
        Assert.Contains("#include \"Common/HashRequestProjection.h\"", threadEntry, StringComparison.Ordinal);
        Assert.Contains("#include \"Common/ThreadDataExecutionAccess.h\"", threadEntry, StringComparison.Ordinal);
        Assert.Contains("HashRequest request = CreateHashRequest(*thrdData);", threadEntry, StringComparison.Ordinal);
        Assert.Contains("HashExecutionContext executionContext = CreateHashExecutionContext(", threadEntry, StringComparison.Ordinal);
        Assert.Contains("GetThreadDataObserver(*thrdData)", threadEntry, StringComparison.Ordinal);
        Assert.Contains("GetMutableThreadDataHashJobState(*thrdData)", threadEntry, StringComparison.Ordinal);
        Assert.Contains("GetMutableThreadDataHashCancellationState(*thrdData)", threadEntry, StringComparison.Ordinal);
