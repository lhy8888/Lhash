...
public sealed class HashContractUnitTests
{
    ...
    public void HashEngine_StartsFromHashRequest_AndEmitsProgressEvents()
    {
        ...
        Assert.Contains("ExecuteOpenedFileDigestUpdate(executionContext, digestUpdateRequest, digestExecutionMode, preferredBufferLength, digestQueuePlan, fsize, isSizeCaled, executionState", digestPipeline, StringComparison.Ordinal);
        ...
        Assert.Contains("unsigned int preferredBufferLength = GetHashDigestBufferPreferredLength(digestBufferPlan);", digestPipeline, StringComparison.Ordinal);
