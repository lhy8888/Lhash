...
public sealed class HashContractUnitTests
{
    ...
    public void HashEngine_StartsFromHashRequest_AndEmitsProgressEvents()
    {
        ...
        Assert.Contains("bool ExecuteOpenedFileDigestUpdate(HashExecutionContext *executionContext, const DigestUpdateRequest& digestUpdateRequest, HashDigestExecutionMode digestExecutionMode, uint64_t fsize, bool isSizeCaled,", digestExecutionHeader, StringComparison.Ordinal);
        Assert.Contains("bool ExecuteOpenedFileDigestUpdate(HashExecutionContext *executionContext, const DigestUpdateRequest& digestUpdateRequest, HashDigestExecutionMode digestExecutionMode, uint64_t fsize, bool isSizeCaled,", digestExecution, StringComparison.Ordinal);
        ...
        Assert.Contains("UpdateDigestContextsParallel(digestUpdateRequest", digestQueue, StringComparison.Ordinal);
        Assert.Contains("ExecuteOpenedFileDigestUpdate(executionContext, digestUpdateRequest, digestExecutionMode, fsize, isSizeCaled, executionState", digestPipeline, StringComparison.Ordinal);
