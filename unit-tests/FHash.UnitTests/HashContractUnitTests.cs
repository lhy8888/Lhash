...
public sealed class HashContractUnitTests
{
    ...
    public void HashEngine_StartsFromHashRequest_AndEmitsProgressEvents()
    {
        ...
        Assert.Contains("HashDigestExecutionMode digestExecutionMode = GetHashJobDigestExecutionMode(executionState->executionPlan);", digestPipeline, StringComparison.Ordinal);
        Assert.Contains("bool ExecuteOpenedFileDigestUpdate(HashExecutionContext *executionContext, const DigestUpdateRequest& digestUpdateRequest, HashDigestExecutionMode digestExecutionMode, const HashDigestQueuePlan& digestQueuePlan, uint64_t fsize, bool isSizeCaled,", digestExecutionHeader, StringComparison.Ordinal);
        Assert.Contains("bool ExecuteOpenedFileDigestUpdate(HashExecutionContext *executionContext, const DigestUpdateRequest& digestUpdateRequest, HashDigestExecutionMode digestExecutionMode, const HashDigestQueuePlan& digestQueuePlan, uint64_t fsize, bool isSizeCaled,", digestExecution, StringComparison.Ordinal);
        ...
        Assert.Contains("ExecuteOpenedFileDigestUpdate(executionContext, digestUpdateRequest, digestExecutionMode, digestQueuePlan, fsize, isSizeCaled, executionState", digestPipeline, StringComparison.Ordinal);
