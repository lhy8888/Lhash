...
internal static class Program
{
    private static int Main()
    {
        ...
        Run("Phase 98 adds a fixed-version OpenSSL EVP family without disturbing the legacy SHA ids", () =>
        {
            ...
            AssertContains(registryCore, "{ \"openssl-blake2b-160\", \"BLAKE2b-160\", true, false }", "Phase 98 is missing the OpenSSL BLAKE2b-160 descriptor.");
            AssertContains(registryCore, "{ \"openssl-blake2b-256\", \"BLAKE2b-256\", true, false }", "Phase 98 is missing the OpenSSL BLAKE2b-256 descriptor.");
            ...
            AssertContains(registryCore, "{ \"openssl-blake2s-128\", \"BLAKE2s-128\", true, false }", "Phase 98 is missing the OpenSSL BLAKE2s-128 descriptor.");
            ...
            AssertContains(digestRegistry, "InitializeOpenSslBlake2b_160DigestContext", "Phase 98 is missing the OpenSSL BLAKE2b-160 digest registration hook.");
            AssertContains(digestRegistry, "InitializeOpenSslBlake2b_256DigestContext", "Phase 98 is missing the OpenSSL BLAKE2b-256 digest registration hook.");
            AssertContains(digestRegistry, "InitializeOpenSslBlake2s_128DigestContext", "Phase 98 is missing the OpenSSL BLAKE2s-128 digest registration hook.");
            ...
            AssertContains(readme, "BLAKE2b-160", "Phase 98 README no longer documents the OpenSSL BLAKE2b-160 variant.");
