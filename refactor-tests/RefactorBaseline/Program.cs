...
internal static class Program
{
    private static int Main()
    {
        ...
        Run("Phase 48 exercises the publish-release chain on manual dispatch while reserving GitHub releases for version tags", () =>
        {
            ...
            AssertContains(workflow, "pattern: LHash-windows-*", "Phase 48 publish-release does not yet target the Windows x64 release artifacts.");
        ...
        Run("Phase 98 adds a fixed-version OpenSSL EVP family as the only active SHA-256/SHA-512 path", () =>
        {
            ...
            AssertContains(changelog, "## 1.12.4 - 2026-04-30", "Phase 98 changelog no longer records the current maintained release note.");
            AssertContains(changelogZh, "## 1.12.4 - 2026-04-30", "Phase 98 Chinese changelog no longer records the current maintained release note.");
